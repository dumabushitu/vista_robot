...
void placeit(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].post_place_retreat.min_distance = 0.15;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene)
{
  ...
  collision_objects[1].id = "cube_marker";
  ...
  collision_objects[1].primitive_poses[0].position.x = transform.getOrigin().x();
  collision_objects[1].primitive_poses[0].position.y = transform.getOrigin().y();
  collision_objects[1].primitive_poses[0].position.z = 0.065;
  collision_objects[1].primitive_poses[0].orientation.x = transform.getRotation().getX();
  collision_objects[1].primitive_poses[0].orientation.y = transform.getRotation().getY();
  collision_objects[1].primitive_poses[0].orientation.z = transform.getRotation().getZ();
  collision_objects[1].primitive_poses[0].orientation.w = transform.getRotation().getW();
